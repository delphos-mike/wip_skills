...
Usage:
    ...
    reply_to_comment.py <discussion_id> --file reply.txt

Examples:
    # Reply to a discussion thread
    reply_to_comment.py def456-disc-id "I agree, let's fix this"

    # Reply from file
    reply_to_comment.py def456-disc-id --file detailed_reply.txt
    ...
    #   reply_to_comment.py $discussion_id "Follow-up thought"
"""
...
def main():
    ...
    try:
        ...
        print(
            f"Replying to discussion {args.discussion_id}...",
            file=sys.stderr,
        )

        result = create_comment(api_key, text, discussion_id=args.discussion_id)
